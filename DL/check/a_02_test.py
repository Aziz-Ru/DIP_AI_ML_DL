...
def test_model():
    ...
    feature,label = extract_feature(cifar10moderl, person_loader)
    run_pca(feature,label, file_name='pca_features_person_cifar10')
    run_tsne(feature,label, file_name='tsne_features_person_cifar10')
    run_umap(feature,label,file_name='umap_feature_person_cifar10')
